...
public class UpdateVO2 implements Serializable {
	...
	public String toString() {
		return "UpdateVO2 [updatedate_sq=" + updatedate_sq + ", lastdate=" + lastdate + ", update_type=" + update_type
				...
				+ verse_en + ", yr=" + yr + ", mon=" + mon + ", ispushed=" + ispushed + "]";
	}
